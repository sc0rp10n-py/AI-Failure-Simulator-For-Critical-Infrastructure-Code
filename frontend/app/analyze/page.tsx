  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-7xl px-6 pt-28 pb-20">
        <div className="mb-10">
          <h1 className="text-4xl font-semibold text-white">Start Analysis</h1>
        ...
        <Card className="mb-10 border-dashed border-cyan-500/40">
          <CardHeader>
            ...
            <CardDescription>Express, Flask, FastAPI, or generic backend archives.</CardDescription>
          </CardHeader>
          <input
            ref={fileRef}
            type="file"
        ...
        <section className="mb-12">
          <h2 className="mb-4 text-xl font-semibold text-white">Demo catalog</h2>
